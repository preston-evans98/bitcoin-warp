...
pub enum NetworkRequest {
    ...
    BlocksByHash(HashSet<BlockHash>),
    ...
    TransactionsByHash(HashSet<TxID>),
    ...
    Headers {
        last_known_headers: Vec<BlockHash>,
